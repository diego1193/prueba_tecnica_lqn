...
class People(TimeStampedModel, SimpleNameModel):
    ...
    hair_color = models.CharField(max_length=32, blank=True, choices=OPTION_HAIR_COLOR)
    skin_color = models.CharField(max_length=32, blank=True)
    eye_color = models.CharField(max_length=32, blank=True, choices=OPTION_EYE_COLOR)
...
class Character(TimeStampedModel, SimpleNameModel):
    """ Personajes del universo de Star Wars """
    ...
    skin_color = models.CharField(max_length=32, blank=True)
    birth_year = models.CharField(max_length=16, blank=True)
    films = models.ManyToManyField(Film, related_name='films_character', blank=True)
